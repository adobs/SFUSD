...
class School:
    ...
    def populate_properties(self):
    	...
    	self.grades_served = self.inputs["Grades served"]
    	...
    	self.before_school_program = self.inputs["Before school programs"]
    	self.before_school_program_offerings = self.inputs["Does your before school program offer:"]
    	self.after_school_program = self.inputs["Afterschool programs"]
    	self.after_school_program_offerings = self.inputs["Does your afterschool program offer:"]
    	self.multilingual_pathways = self.inputs["Multilingual Pathways"]
